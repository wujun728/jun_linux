package com.machine.window;
	...
	public class Regtree {
	       ...
	       JTextField tolstext = new JTextField();
	       JTextField tolntext = new JTextField();
	       ...
	       public Regtree(){
	    	   ...
	    	   JLabel tols = new JLabel();
	    	   JLabel toln = new JLabel();
	           ...
	           redo1.setText("重置");
				...
				tolstext.setText("容许误差下降值（整数）");
				tolstext.setForeground(Color.gray);
				tolntext.setText("切分最少样本数（整数)");
				tolntext.setForeground(Color.gray);
				splittypetext.setText("分割符");
				splittypetext.setForeground(Color.gray);
				
				
				tolntext.addMouseListener(new MouseListener(){

					@Override
					public void mouseClicked(MouseEvent e) {
						// TODO Auto-generated method stub
						tolntext.setText("");
						tolntext.setForeground(Color.BLACK);
					}
				...
				tolstext.addMouseListener(new MouseListener(){

					@Override
					public void mouseClicked(MouseEvent e) {
						// TODO Auto-generated method stub
						tolstext.setText("");
						tolstext.setForeground(Color.BLACK);
					}
	           ...
	           run.addActionListener(new java.awt.event.ActionListener(){
	      			...
	      			public void actionPerformed(ActionEvent e) {
	      				...
	      				Pythondata.tols = Integer.parseInt(tolstext.getText().trim());
	      				Pythondata.toln = Integer.parseInt(tolntext.getText().trim());
