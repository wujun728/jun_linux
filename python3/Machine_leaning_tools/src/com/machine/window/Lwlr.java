package com.machine.window;
	...
	public class Lwlr {
	       ...
	       JTextField lowspeedtext = new JTextField();
	       ...
	       public Lwlr(){
	           ...
	           redo1.setText("重置");
				...
				lowspeedtext.setText("权重衰减速度（浮点数）");
				lowspeedtext.setForeground(Color.gray);
				...
				lowspeedtext.addMouseListener(new MouseListener(){

					@Override
					public void mouseClicked(MouseEvent e) {
						// TODO Auto-generated method stub
						lowspeedtext.setText("");
						lowspeedtext.setForeground(Color.BLACK);
					}
	           ...
	           run1.addActionListener(new java.awt.event.ActionListener(){
	     			...
	     			public void actionPerformed(ActionEvent e) {
	     				...
	     				Pythondata.lowspeed = Float.parseFloat(lowspeedtext.getText().trim());
