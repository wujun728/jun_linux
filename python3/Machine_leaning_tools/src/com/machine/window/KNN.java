package com.machine.window;
	...
	public class KNN {
	       ...
	       JTextField knntext = new JTextField();
	       ...
	       public KNN(){
	           ...
	           redo1.setText("重置");
				...
				knntext.setText("距离预测点最近个数（整数）");
				knntext.setForeground(Color.gray);
				...
				knntext.addMouseListener(new MouseListener(){

					@Override
					public void mouseClicked(MouseEvent e) {
						// TODO Auto-generated method stub
						knntext.setText("");
						knntext.setForeground(Color.BLACK);
					}
	           ...
	           run.addActionListener(new java.awt.event.ActionListener(){
	      			...
	      			public void actionPerformed(ActionEvent e) {
	      				...
	      				Pythondata.knn = Integer.parseInt(knntext.getText().trim());
