package com.machine.window;
	...
	public class Point_legend {
		...
		private void drew() {
			// TODO Auto-generated method stub
				String[] point_legend = {"python","scantter_with_legend.py",Drewdata.drewfile,String.valueOf(Drewdata.x),
						String.valueOf(Drewdata.y),Drewdata.splittype};
						ProcessBuilder processBuilder = new ProcessBuilder();
						URL str = this.getClass().getClassLoader().getResource("com/machine/drew");
						processBuilder.command(point_legend);  
