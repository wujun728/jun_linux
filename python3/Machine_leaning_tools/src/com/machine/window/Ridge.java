package com.machine.window;
	...
	public class Ridge {
	       ...
	       JTextField lamtext = new JTextField();
	       ...
	       public Ridge(){
	           ...
	           redo1.setText("重置");
				...
				numtext.setText("迭代次数（整数）");
				numtext.setForeground(Color.gray);
				lamtext.setText("步长个数（整数)");
				lamtext.setForeground(Color.gray);
				...
				lamtext.addMouseListener(new MouseListener(){

					@Override
					public void mouseClicked(MouseEvent e) {
						// TODO Auto-generated method stub
						lamtext.setText("");
						lamtext.setForeground(Color.BLACK);
					}
	           ...
	           run.addActionListener(new java.awt.event.ActionListener(){
	      			...
	      			public void actionPerformed(ActionEvent e) {
	      				...
	      				Pythondata.numiter= Integer.parseInt(numtext.getText().trim());
	      				Pythondata.lamnum= Integer.parseInt(lamtext.getText().trim());
