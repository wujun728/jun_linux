package com.machine.window;
	...
	public class Apriori {
	       ...
	       JTextField minconftext = new JTextField();
	       ...
	       public Apriori(){
	           ...
	           redo1.setText("重置");
				...
				minsupporttext.setText("最小支持度（浮点型）");
				...
				minconftext.setText("最小可信度（浮点数）");
				minconftext.setForeground(Color.gray);
				...
				minconftext.addMouseListener(new MouseListener(){

					@Override
					public void mouseClicked(MouseEvent e) {
						// TODO Auto-generated method stub
						minconftext.setText("");
						minconftext.setForeground(Color.BLACK);
					}
	           ...
	           run1.addActionListener(new java.awt.event.ActionListener(){
	     			...
	     			public void actionPerformed(ActionEvent e) {
	     				// TODO Auto-generated method stub
	     				Pythondata.minsupport = Float.parseFloat(minsupporttext.getText().trim());
	     				Pythondata.testfile = prefiletext.getText();
	     				Pythondata.outfile = outfiletext.getText();
	     				Pythondata.minconf = Float.parseFloat(minconftext.getText().trim());
