...
DOCKER_PROJECT=base
DOCKER_IMAGE=alpine
DOCKER_FILE=alpine-singleapp-dockerfile
...
docker build --rm \
             ...
             --build-arg MYAPP_VER=1.0.2 \
             -t ${DOCKER_REPOSTORY}/${DOCKER_PROJECT}/${DOCKER_IMAGE}:singleapp-1.0.2 \
             -t ${DOCKER_REPOSTORY}/${DOCKER_PROJECT}/${DOCKER_IMAGE}:singleapp-1.0 \
             -f ${DOCKER_FILE} .
