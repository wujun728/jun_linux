...
DOCKER_PROJECT=base
DOCKER_IMAGE=alpine
DOCKER_FILE=alpine-tomcatapp-dockerfile
...
docker build --rm \
             ...
             --build-arg MYAPP_VER=8.0.52 \
             -t ${DOCKER_REPOSTORY}/${DOCKER_PROJECT}/${DOCKER_IMAGE}:tomcatapp-8.0.52 \
             -t ${DOCKER_REPOSTORY}/${DOCKER_PROJECT}/${DOCKER_IMAGE}:tomcatapp-8.0 \
             -f ${DOCKER_FILE} .
...
docker build --rm \
             ...
             --add-host codeload.github.com:192.30.253.121 \
             --add-host raw.githubusercontent.com:151.101.72.133 \
             --build-arg MYAPP_VER=8.5.31 \
             -t ${DOCKER_REPOSTORY}/${DOCKER_PROJECT}/${DOCKER_IMAGE}:tomcatapp-8.5.31 \
             -t ${DOCKER_REPOSTORY}/${DOCKER_PROJECT}/${DOCKER_IMAGE}:tomcatapp-8.5 \
             -f ${DOCKER_FILE} .
